...
<template>
  <div :style="style">
    <div class="grid">
      <div class="col-12">
        <div class="m-1 text-xl w-10 font-semibold text-primary">{{ params.editor_header }}</div>
        <div class="m-1 card">
          <HandSonTbl @keydown="onKeyDown" :data="table_data" :hotSettings="tbl_settings" :key="counter"></HandSonTbl>
