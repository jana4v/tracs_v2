    ...
    >
      <template #container>
        ...
        <div class="sidenav-header">
          ...
          <h2 class="app-title">{{ side_nav_config.app_name }}</h2>
        ...
        >
          <template #item="{ item, props }">
            <router-link v-if="item.route" v-slot="{ href, navigate }" :to="item.route" custom>
              <div 
                :class="['menu-item', { 'menu-item--active': menu_selected_item === item.label }]" 
...
visible.value = side_nav_config.value.show_side_nav;
const menu_selected_item = ref("")

const selected_item = (label: string) => {
