...
<template>
  <MultiSelect ref="dropdownRef" v-model="selectedOptions" :options="options" filter option-label="value" :placeholder="props.params.placeholder" :style="style" display="chip" @hide="ValueChanged">
    <template #footer>
      <div class="py-2 px-3">
